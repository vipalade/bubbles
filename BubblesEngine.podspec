...
Pod::Spec.new do |s|
  ...
  s.name         = "BubblesEngine"
  s.version      = "0.0.1"
  s.summary      = "Bubbles C++ Engine"
  ...
  s.description  = <<-DESC
    A very interesting POD description.
                   DESC

  s.homepage     = "https://github.com/vipalade/bubbles.git"
  ...
  # Or just: s.author    = "Valentin Palade"
  # s.authors            = { "Valentin Palade" => "vipalade@gmail.com" }
  # s.social_media_url   = "http://twitter.com/Valentin Palade"
  ...
  s.source       = { :git => "https://github.com/vipalade/bubbles.git" }
